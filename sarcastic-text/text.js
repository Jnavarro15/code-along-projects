...
const filters = {
  ...
  funky(letter) {
    // first check if there is a funky lettr for this case
    let funkyLetter = funkyLetters[letter];
    if (funkyLetter) return funkyLetter;
    // if there is not, check if theres is a lower case version
  ...
  unable(letter) {
    // one in three places will take a ...
...
function transformText(text) {
  ...
  return (result.textContent = mod.join(''));
}
