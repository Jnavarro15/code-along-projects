...
})({"15378ca62ccedc45c4c10f23ce5f7da6":[function(require,module,exports) {
/* Disable-eslint */
...
const SIZE = 10; // write a function that will populate the users video
...
async function detect() {
  ...
  faces.forEach(drawFace); // faces.forEach(censor);
...
function censor({
  ...
  faceCtx.imageSmoothingEnabled = false; // faceCtx.clearRect(0, 0, faceCanvas.width, faceCanvas.height);
  // draw the small face
  ...
  face.y, SIZE, SIZE // how wide
  ); // draw the small face back on, but scale up

  faceCtx.drawImage(faceCanvas, // source
  face.x, // where do we start the source pull from?
  face.y, SIZE, SIZE, // drawing args
  face.x, face.y, face.width, face.height); // take that face back out and draw it back at normal size.
...
},{}]},{},["dbf1218a5157915fae56d372bc4c8638","15378ca62ccedc45c4c10f23ce5f7da6"], null)

//# sourceMappingURL=pixelated-face.95585d2c.js.map
