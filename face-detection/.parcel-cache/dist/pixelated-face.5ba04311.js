...
const SIZE = 10;
const SCALE = 1.35; // write a function that will populate the users video
...
function censor({
  ...
  face.x - (width - face.width) / 2, face.y - (width - face.height) / 2, width, height); // take that face back out and draw it back at normal size.
}
...
//# sourceMappingURL=pixelated-face.5ba04311.js.map
